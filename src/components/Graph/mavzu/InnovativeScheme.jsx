...
import { FaPlus, FaTimes, FaFilePdf, FaEye, FaTrash, FaProjectDiagram, FaLightbulb, FaCogs, FaChartLine } from 'react-icons/fa';
import ConfirmModal from '../../Common/ConfirmModal';
import '../mavzu/MainView.css';

function InnovativeScheme({ isSuperAdmin }) {
    ...
    useEffect(() => {
        const fetchPdfs = async () => {
            try {
                // Eslatma: Backendda 'innovative-scheme-pdfs/' endpointi bo'lishi kerak
                const response = await axiosInstance.get('innovative-scheme-pdfs/');
    ...
    const handleSubmitPdf = async (e) => {
        ...
        try {
            await axiosInstance.post('upload-innovative-pdf/', formData, {
    ...
    const confirmDelete = async () => {
        try {
            await axiosInstance.delete(`delete-innovative-pdf/${confirmModal.id}/`);
        ...
        <div className="page-container">
            <div className="page-header">
                <div className="page-header-content">
                    <h1>Innovatsion ta'lim sxemasi</h1>
                    <p>O'qitishning zamonaviy usullari va innovatsion texnologiyalari bo'yicha hujjatlar</p>
                </div>
                {isSuperAdmin && (
                ...
                <div className="modal-overlay" onClick={() => setShowPdfModal(false)}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-header">
                            <h2>PDF yuklash</h2>
                            <p>Innovatsion sxema uchun PDF hujjat yuklang</p>
                        </div>
                        <form onSubmit={handleSubmitPdf} className="modal-form">
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    placeholder="Masalan: Innovatsion o'qitish metodlari"
                                    value={title}
...
export default InnovativeScheme;
